...
$(function () {
	...
	function showMsg(data) {
		var msg = $(data.input).parent().parent().find('.msg');
...
$(function(){
  ...
  $('#drag-and-drop-zone').dmUploader({ //
    ...
    onNewFile: function(id, file){
      ...
      $('.load-file-caption').text(file["name"]);
    ...
    onUploadSuccess: function(id, data){
      ...
      $('.val-file').val('http://kitchen.local/uploads/images/' + data.name);
      $('.val-file').attr('value', 'http://kitchen.local/uploads/images/' + data.name);
...
$('.btn_load-file').on('click', function () {
	$('#file').trigger('click');
});